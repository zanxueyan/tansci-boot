...
<p align="center">基于 SpringBoot3 + magic-api + Vue3 + Element Plus + amis3.0 + Flowable 快速开发管理系统</p>

Tansci-Boot 是一个前后端分离后台管理系统，前端集成 `amis` 低代码前端框架，后端集成 `magic-api` 的接口快速开发框架和 `Flowable` 工作流引擎。包含基础权限、安全认证、以及常用的一些组件功能。项目易上手，技术更综合，能力更全面。
...
[Flowable](https://www.flowable.org/) 是一个用 Java 编写的轻量级工作流引擎，支持 BPMN 2.0 标准，可以嵌入到任何 Java 应用程序中。它提供了工作流和业务流程管理的功能，帮助开发者构建复杂的业务流程应用。
